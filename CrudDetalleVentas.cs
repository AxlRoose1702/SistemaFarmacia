    ...
    public partial class CrudDetalleVentas : Form
    {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                commandQryActualiza.Parameters.AddWithValue("@CodigoDetalleVenta", txtCodigoDetalleV.Text);
                commandQryActualiza.Parameters.AddWithValue("@CodigoVenta", txtCodVenta.Text);
                commandQryActualiza.Parameters.AddWithValue("@CodigoMedicamento", txtCodMedicamento.Text);
                commandQryActualiza.Parameters.AddWithValue("@Cantidad", txtCantidad.Text);
                commandQryActualiza.Parameters.AddWithValue("@PrecioUnitario", txtPrecio.Text);
                commandQryActualiza.Parameters.AddWithValue("@Descuento", txtDescuento.Text);
                commandQryActualiza.Parameters.AddWithValue("@Impuesto", txtImpuesto.Text);
                commandQryActualiza.Parameters.AddWithValue("@Total", txtTotal.Text);
