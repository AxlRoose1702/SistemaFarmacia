...
namespace SistemaFarmacia
{
    public partial class CrudProveedores : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            string QryProveedores = "Delete from tbl_proveedores where CodigoProveedor=@CodigoProveedor";
            SqlCommand commandQryEliminar = new SqlCommand(QryProveedores, conn);
            commandQryEliminar.Parameters.AddWithValue("@CodigoProveedor", txtCodigoProveedor.Text);
